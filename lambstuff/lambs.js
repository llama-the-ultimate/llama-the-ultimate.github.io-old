          ...
          var find = function (tp) {
              return function (t) {
                  var next = function (v) {
                      ...
                      throw new Error("Failed pattern match at Lambs.Term line 62, column 9 - line 62, column 40: " + [ v.constructor.name ]);
                  };
                  var v = pred(t);
                  if (v instanceof Data_Maybe.Nothing) {
                      return next(t);
...
(function(exports) {
  ...
  var subst = function (v) {
      var halp = function (v1) {
          ...
          throw new Error("Failed pattern match at Lambs.Subst line 29, column 5 - line 29, column 25: " + [ v1.constructor.name ]);
      };
  ...
  var removeDef = function (v) {
      return function (v1) {
          var removeFrom = function (v2) {
              ...
              throw new Error("Failed pattern match at Lambs.Define line 68, column 5 - line 68, column 25: " + [ v2.constructor.name ]);
          };
  ...
  var addDef = function (v) {
      return function (v1) {
          var addTo = function (v2) {
              ...
              throw new Error("Failed pattern match at Lambs.Define line 58, column 5 - line 58, column 38: " + [ v2.constructor.name ]);
          };
...
(function(exports) {
  ...
  var freeIds = function (t) {
      var free = function (v) {
          return function (bound) {
              ...
              throw new Error("Failed pattern match at Lambs.Eval line 38, column 5 - line 38, column 53: " + [ v.constructor.name, bound.constructor.name ]);
          };
      };
  ...
  var uniqueId = function (used) {
      return function (str) {
          var halp = function ($copy_s) {
              return function ($copy_n) {
                  var $tco_var_s = $copy_s;
                  var $tco_done = false;
                  var $tco_result;
                  function $tco_loop(s, n) {
                  ...
                  while (!$tco_done) {
                      $tco_result = $tco_loop($tco_var_s, $copy_n);
                  };
                  return $tco_result;
              };
          };
          ...
          var find = function (tp) {
              return function (t) {
                  var next = function (v1) {
                      ...
                      throw new Error("Failed pattern match at Lambs.Eval line 115, column 9 - line 115, column 47: " + [ v1.constructor.name ]);
                  };
  ...
  var allIds = function (v) {
      ...
      throw new Error("Failed pattern match at Lambs.Eval line 44, column 1 - line 44, column 33: " + [ v.constructor.name ]);
  };
  ...
  var stepExec = function (term) {
      ...
      var reduceRename = function (v) {
          return function (v1) {
              ...
              throw new Error("Failed pattern match at Lambs.Eval line 132, column 5 - line 132, column 66: " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
...
(function(exports) {
  ...
  var run = function (p) {
      return function (x) {
          ...
          throw new Error("Failed pattern match at Lambs.Parse line 126, column 3 - line 128, column 22: " + [ v.constructor.name ]);
      };
  };
  ...
  var removeComment = function (s) {
      ...
      throw new Error("Failed pattern match at Lambs.Parse line 149, column 3 - line 151, column 21: " + [ v.constructor.name ]);
  }; 
  var identifier = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(many1(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(function (x) {
      ...
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(listString($58));
  });
  var lam = function (x) {
  ...
  var $$var = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(identifier)(function ($59) {
      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Lambs_Term.Var.create($59));
  });
  ...
  var exp = (function () {
      var notAppW = function (ex) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(white)(function (v) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(notApp(ex))(function (v1) {
      ...
      var applify = function (v) {
          ...
          throw new Error("Failed pattern match at Lambs.Parse line 88, column 5 - line 89, column 5: " + [ v.constructor.name ]);
      };
  ...
  var parseTop = function (str) {
      ...
      if (v instanceof Data_Maybe.Nothing) {
          ...
          if (v1 instanceof Data_Maybe.Nothing) {
              ...
              throw new Error("Failed pattern match at Lambs.Parse line 142, column 11 - line 144, column 31: " + [ v2.constructor.name ]);
          };
          throw new Error("Failed pattern match at Lambs.Parse line 139, column 7 - line 144, column 31: " + [ v1.constructor.name ]);
      };
      throw new Error("Failed pattern match at Lambs.Parse line 136, column 3 - line 144, column 31: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var unparse = function (v) {
      ...
      throw new Error("Failed pattern match at Lambs.Unparse line 17, column 1 - line 17, column 26: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var renameDefs = function (d) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main line 53, column 1 - line 53, column 54: " + [ d.constructor.name, v.constructor.name ]);
      };
  };
  ...
  var execStr = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 46, column 1 - line 46, column 32: " + [ v.constructor.name ]);
  };
  var step = function (v) {
      if (v instanceof Data_Maybe.Nothing) {
          return ":(";
      ...
      throw new Error("Failed pattern match at Main line 22, column 1 - line 22, column 33: " + [ v.constructor.name ]);
  };
