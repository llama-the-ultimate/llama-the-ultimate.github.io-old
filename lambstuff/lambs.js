...
(function(exports) {
  ...
  var stepExec = function (term) {
      var renameHalp = function (v) {
          return function (v1) {
              return new Rename(v1.value0, term, v1.value1, new Lambs_Term.App(new Lambs_Term.Lam(v.value1.value1, Lambs_Term.fillTerm(v.value0)(v1.value2)), v.value1.value0));
          };
      };
...
(function(exports) {
  ...
  var identifier = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(many1(Text_Parsing_Parser_Token.alphaNum(Data_Identity.monadIdentity)))(function ($57) {
